const translations = {
  ja: {
    ...
    featureDesignTitle: "自社企画",
    featureDesignBody: "暮らしの中で使いやすく、店頭でも選ばれやすいインテリア製品を企画します。",
    featureNetworkTitle: "生産背景",
    featureNetworkBody: "フロアマット、寝具、雑貨など幅広いカテゴリーで、品質と価格の両立を目指します。",
    featureOemTitle: "OEM・ODM",
    featureOemBody: "お客様のブランドや販売計画に合わせた製品づくりのご相談に対応します。",
  ...
  en: {
    ...
    featureDesignTitle: "In-house Planning",
    featureDesignBody: "We plan interior products that are easy to use at home and easy to choose in stores.",
    featureNetworkTitle: "Production Network",
    featureNetworkBody: "Across floor mats, bedding, and household goods, we pursue both reliable quality and practical pricing.",
    featureOemTitle: "OEM / ODM",
    featureOemBody: "We support product development aligned with customer brands, sales plans, and production needs.",
    homeCtaKicker: "Contact",
